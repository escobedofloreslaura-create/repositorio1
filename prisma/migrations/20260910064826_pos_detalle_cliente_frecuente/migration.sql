...
CREATE TABLE "new_PosDetalleVenta" (
    ...
    "esClienteFrecuente" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_PosDetalleVenta" ("cantidad", "cantidadDevuelta", "costoUnitario", "descripcion", "esMayoreo", "id", "precioUnitario", "productoId", "subtotal", "ventaId") SELECT "cantidad", "cantidadDevuelta", "costoUnitario", "descripcion", "esMayoreo", "id", "precioUnitario", "productoId", "subtotal", "ventaId" FROM "PosDetalleVenta";
